...
![example branch parameter](http://jenkins.betalabs.ai/buildStatus/icon?job=elsie-admin-portal&subject=Jenkins%20staging%20Build)](http://jenkins.betalabs.ai/blue/organizations/jenkins/elsie-admin-portal/activity)
