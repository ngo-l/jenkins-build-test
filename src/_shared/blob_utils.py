...
class BlobUtil:
    def __init__(self,
        ...
        self.blob_service_client = BlobServiceClient.from_connection_string(
            storage_account_connection_string.get_secret_value())
    ...
    def create(self, container_name: str, blob_path: str, data):
        ...
        while True:
            ...
            blob_path = f"{filename}-{int(time.time())}.{ext}"
    ...
    def move_blob_file(self,
        ...
        time_waited = 0
        # TODO: replace by CopyStatus enum
        # ref: https://markheath.net/post/azure-blob-copy-quick
